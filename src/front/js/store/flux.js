...
const getState = ({ getStore, getActions, setStore }) => {
  const API_URL = "https://sample-service-name-1v6u.onrender.com";
  ...
  return {
    ...
    actions: {
      ...
      deletePackage: async (package_id) => {
        ...
        try {
          const response = await axios.delete(
            `${API_URL}/api/package/` + package_id,
            {
              data: {
      ...
      getFavorites: async () => {
        ...
        try {
          const response = await axios.get(
            `${API_URL}/api/user/` + user_id + "/favorites"
          );
          setStore({
 ...
 //-----------------------------------------------------------------------------------------------------------------------------
      ...
      getProductComments: async (id) => {
        ...
        try {
          const response = await fetch(
            `${API_URL}/api/package/` + id + "/comments"
          );
          const data = await response.json();
      ...
      getCommentsK: async () => {
        ...
        try {
          const response = await axios.get(
            `${API_URL}/api/user/` + user_id + "/comments"
          );
          setStore({
...
//-----------------------------------------------------------------------------------------------------------------------------
      ...
      deleteComments: async (comment_id) => {
        ...
        try {
          const response = await axios.delete(
            `${API_URL}/api/comments/` + user_id + "/" + comment_id,          
          );
          // Sweet alert
          Swal.fire({ text: response.data.msg, confirmButtonColor: "#000000" });
