...
import { FaIdCard, FaRegMoneyBillAlt, FaRoute, FaPlane, FaCar, FaPrint, FaHandHoldingUsd, FaSun, FaSuitcaseRolling} from "react-icons/fa";
...
<div class="accordion" id="accordionExample">
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      Apply for your online VISA before you travel. You can apply for single entry and transit visas on the <strong>evisas website</strong> . For more information on different types of visas see the website of the <strong>Kenya High Commission.</strong>
        <p></p> 
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      Park fees ( 24h period ) are charged by the Maasai Mara National Reserve:
        <p></p> 
        70 USD per Adults
        <p></p>
...
<br/>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <strong className='FAQ'>BY PLANE<i class="FAQHeaderP fas fa-plane"></i></strong>
        <p></p> 
        ...
        <p></p>
        <strong className='FAQ'>BY ROAD<i class=" FAQHeaderP fas fa-car"></i></strong>
        <p></p>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      ...
      <p></p>
      <ul>
        <li>Guided safaris with the most experienced maasai spotters</li>
        <li>All meals and drinks (including safari snacks)</li>
        <li>Laundry</li>
        <li>WIFI</li>
      ...
      <p></p>
      <ul>
        <li>Park fees ( Adults 70 USD per day / Children  40 USD per day)</li>
        <li>Transport by road to the Reserve’s Gate</li>
        <li>Flights to Maasai Mara</li>
        <li>Gratuities</li>
        <li>Hot Balloon services</li>
        <li>Guarantee private safari services ( upon request)</li>
      </ul>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <strong className='FAQ'>HIGH SEASON : JUNE- OCTOBER</strong> 
        <p></p>
        ...
        <p></p>
        Migration occurs between Tanzania Serengeti’s Plain in the south and Kenya Maasai Mara in the north. It is one of the most fascinating spectacles and a must see in a life time.
        <p></p>
        <strong className='FAQ'>MID & LOW SEASON  : NOVEMBER- MAY</strong>
        <p></p>
    ...
    <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul>
          ...
          <li>Hat</li>
          <li>Comfortable clothes & Jacket ( temperatures  go from 14º in the sunrise -25º/30º during the day)</li>
        </ul>
      </div>
    </div>
  </div>
