    ...
    <div className="pagesBackground">
      ...
      <Carousel.Item>
        ...
        <div className="row row-cols-2 g-3 mt-5">
          {/* --this div wraps the 2 colums layout-- */}
            ...
            <div className="card m-3 border-light">
              ...
              <div className="description-content">
                <p>
                  ...
                  Mara-Serengeti Eco-System. For centuries the Maasai tribe has
                  ...
                  observe the wildlife of the African Savannah. Our custom built
                  4×4 vehicles allow us to access the most remote places where
                  we avoid the more crowded routes of the Mara as well as to
                  enjoy privacy during our safaris.
                </p>
              </div>
            </div>
          </div>
        </div>
        {/* --Here ends the Wrapper for the 2 colums layout-- */}

        <div className="row row-cols-2 g-3 mt-5">
          {/* --this div wraps the SECOND 2 colums layout-- */}
        ...
        {/* --Here ends the Wrapper for the SECOND 2 colums layout-- */}
